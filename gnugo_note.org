...
[[Topology_of_Half_Eyes_and_False_Eyes][Topology of Half Eyes and False Eyes]]）。
...
第二個眼形在 ='a'= 具有半只眼（當 ='O'= 或 ='X'= 落子在 ='b'= 處），這是由拓撲標
準所發現的。（參考[[Topology_of_Half_Eyes_and_False_Eyes][Topology of Half Eyes and False Eyes]]。）

在圖匹配的過程中，通過將 ='....'= 左邊的 ='.'= 替換為 ='!.'= 來修改 =eye_shape=
圖。
